...
CRM_NAME := libcrm_fw_upload_sofia_secvm
...
include $(LOCAL_PATH)/../../../makefiles/crm_clear.mk
CRM_NAME := crm_test_fw_upload_sofia_secvm
...
CRM_SHARED_LIBS_ANDROID_ONLY := libc
CRM_SHARED_LIBS := libcrm_fw_upload_sofia_secvm libcrm_utils
